 ...
 * @author USER
 */
public class jbook_entry extends javax.swing.JFrame {

    /**
     * Creates new form jbook_entry
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Entry  Form For Job Book");
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        else
        {
            ...
            String  book_name = jTextField2.getText().trim();
            String  author = jTextField3.getText().trim();
            String  issue_date= jTextField4.getText().trim();
            String  isbn = jTextField5.getText().trim();
            String  adition = jTextField6.getText().trim();

            jbook_class a = new jbook_class(department,book_name,author,issue_date,isbn,adition);
            jbooks.add(a);
            savejbooksToFile();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jbook_entry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jbook_entry().setVisible(true);
            }
        });
    }
