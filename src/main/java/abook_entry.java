...
import java.util.*;
import java.io.*;
public class abook_entry extends javax.swing.JFrame {
  ArrayList<abook_class> abooks;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Entry  Form For Academic Book");
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        abook_class abc = new abook_class(department,book_name,author,issue_date,isbn);
        abooks.add(abc);
        saveabooksToFile();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(abook_entry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new abook_entry().setVisible(true);
            }
        });
    }
